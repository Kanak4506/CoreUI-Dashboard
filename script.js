...
notification_btn.addEventListener("click", () => {
  ...
  notification_btn.src = notification_flag
    ? "assets/icons/up.svg"
    : "assets/icons/down.svg";
...
function accountDropdown() {
  ...
  document.addEventListener("click", (event) => {
    if (
      ...
      !account_btn.contains(event.target)
    ) {
...
const typography_content = document.querySelector(
  ".typography_content_container"
);
